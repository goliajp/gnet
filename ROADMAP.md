...
| **v0.24** | Track E presentation (CI enable, rustfmt pin, CONTRIBUTING, deploy docs, README) | quality gate green | **partial — docs landed; CI enable + rustfmt pin awaiting operator** |
